...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(mainWorkArea, javax.swing.GroupLayout.DEFAULT_SIZE, 3, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    mainWorkArea.add(ls, "LoginScreen"); // Make sure to specify a unique name for this card.
    CardLayout layout = (CardLayout) mainWorkArea.getLayout();
    layout.show(mainWorkArea, "LoginScreen"); // Show the "LoginScreen" card.
}
