...
public class SearchForProductJPanel extends javax.swing.JPanel {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
      ...
      Product searchProduct = supplier.getProductCatalog().searchProduct(Integer.parseInt(productId));

if (searchProduct != null) {
    ViewProductDetailJPanel productDetailPanel = new ViewProductDetailJPanel(workArea,searchProduct );
    workArea.removeAll();
    workArea.add("ViewProductDetail", productDetailPanel);
    CardLayout layout = (CardLayout) workArea.getLayout();
    layout.show(workArea, "ViewProductDetail");
} else {
