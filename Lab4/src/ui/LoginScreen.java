...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        JPanel selectedPanel=(JPanel)cmbRoles.getSelectedItem();
         if (selectedPanel instanceof AdminWorkAreaJPanel) {
        // If it's an admin role, open AdminWorkAreaJPanel
        selectedPanel = new AdminWorkAreaJPanel(mainWorkArea, supplierDirectory);
       }
         else if (selectedPanel instanceof SupplierWorkAreaJPanel) {
        // If it's a supplier role, open SupplierWorkAreaJPanel with the selected supplier
        ...
        mainWorkArea.add("AdminWorkAreaJPanel",selectedPanel);
