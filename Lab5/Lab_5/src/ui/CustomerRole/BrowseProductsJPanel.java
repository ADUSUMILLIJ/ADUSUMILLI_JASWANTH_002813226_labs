...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
     ...
     currentOrder=new Order();
        ...
        spnQuantity.setValue(0);
         ...
         JOptionPane.showMessageDialog(this, "Thankyou for your purchase.Lookig forward to see you again");
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
       ...
       try{
        ...
        int oldQunt=item.getQuantity();
            if(item.getProduct().getAvail()+oldQunt<quant){
            JOptionPane.showMessageDialog(this, "Please check product availability."); 
            return;
        }
            item.getProduct().setAvail(item.getProduct().getAvail()+oldQunt-quant);
